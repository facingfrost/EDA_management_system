...
def loadData_E4(file_EDA,file_ACC,file_TEMP):
    # Load EDA data
    eda_data = _loadSingleFile_E4(file_EDA,["EDA"],4,"250L")
    # Get the filtered data using a low-pass butterworth filter (cutoff:1hz, fs:8hz, order:6)
    eda_data['filtered_eda'] =  butter_lowpass_filter(eda_data['EDA'], 1.0, 8, 6)

    # Load ACC data
    acc_data = _loadSingleFile_E4(file_ACC,["AccelX","AccelY","AccelZ"],32,"31250U")
    # Scale the accelometer to +-2g
    acc_data[["AccelX","AccelY","AccelZ"]] = acc_data[["AccelX","AccelY","AccelZ"]]/64.0

    # Load Temperature data
    temperature_data = _loadSingleFile_E4(file_TEMP,["Temp"],4,"250L")
...
if __name__ == "__main__":
    print(loadData_E4("D:\大四下\毕设\论文\sample_E4\EDA.csv","D:\大四下\毕设\论文\sample_E4\ACC.csv","D:\大四下\毕设\论文\sample_E4\TEMP.csv"))